<template>
  <!-- ========== FOOTER ========== -->
  <footer class="mt-auto w-full py-10 px-4 sm:px-6 lg:px-8 mx-auto border-t bg-white">
    <!-- Grid -->
        ...
        <div class="flex flex-wrap items-center gap-3">
          ...
          <div class="hs-dropdown [--placement:top-left] relative inline-flex">
            ...
            >
              ...
              English (US)
              <svg
                class="hs-dropdown-open:rotate-180 shrink-0 size-4 text-gray-500"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            >
              <a
                class="flex items-center gap-x-2 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100"
                href="#"
              >
                <svg
        ...
        <div class="flex flex-wrap justify-between items-center gap-3">
          <div class="mt-3 sm:hidden">
            <a
              ...
              >Brand</a
            >
            <p class="mt-1 text-xs sm:text-sm text-gray-600">© 2024 Preline Labs.</p>
          </div>
