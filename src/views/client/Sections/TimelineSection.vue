<template>
  <!-- Timeline -->
  <div class="border rounded-xl border-gray-200 p-3 my-5 focus:shadow-lg hover:shadow-lg">
    <!-- Item -->
    <div class="group relative flex gap-x-5">
      ...
      <div class="grow pb-8 group-last:pb-0">
        <h3 class="mb-1 text-xs text-gray-600">2023 - Present</h3>

        <p class="font-semibold text-sm text-gray-800">Web Designer & Web Developer</p>
    ...
    <div class="group relative flex gap-x-5">
      ...
      <!-- Right Content -->
      <div class="grow pb-8 group-last:pb-0">
        <h3 class="mb-1 text-xs text-gray-600">2021 - 2023</h3>

        <p class="font-semibold text-sm text-gray-800">Senior Software Engineer at Mailchimp</p>

        <p class="mt-1 text-sm text-gray-600">
          This is an excellent company and they reward their employees. It's becoming a big company
          but it's still private, so the culture is as good as it gets at 1,000+ employees if you
          ask me. Managers are still adapting to the growth I think, but everyone has to. Great
          place to work.
        </p>
            ...
            <div class="relative flex items-center overflow-hidden">
              ...
              <div class="grow p-4 ms-32 sm:ms-48">
                <div class="min-h-24 flex flex-col justify-center">
                  <h3 class="font-semibold text-sm text-gray-800">Studio by Mailchimp</h3>
    ...
    <div class="group relative flex gap-x-5">
      ...
      <!-- Right Content -->
      <div class="grow pb-8 group-last:pb-0">
        <h3 class="mb-1 text-xs text-gray-600">2011 - 2021</h3>

        <p class="font-semibold text-sm text-gray-800">Junior Software Engineer at Slack</p>
    ...
    <div class="group relative flex gap-x-5">
      ...
      >
        <div class="relative z-10 size-6 flex justify-center items-center">
          <svg
            class="shrink-0 size-6 text-gray-800"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      <!-- Right Content -->
      <div class="grow pb-8 group-last:pb-0">
        <h3 class="mb-1 text-xs text-gray-600">2010 - 2011</h3>

        <p class="font-semibold text-sm text-gray-800">Freelance Graphic Designer</p>
